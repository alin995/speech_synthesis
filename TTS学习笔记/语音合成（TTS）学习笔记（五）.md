...
<img align=“center” src="/img/gygongshi01.png"/>
...
<img align=“center” src="/img/gygongshi02.png"/>
...
> 在真实数据test_all得到了一个ε 0 
>
> 不同的测试集 错误率不同   同一个模型在t上测试了很多次 得到的结果也不同这样的情况下 怎样去评估真实数据的泛化能力  尤其是在真实数据上多大程度上去保证这个真实数据的泛化能力 
...
以上主要是对机器学习有关模型的评估与选择方法一些基础理论知识的简单整理。
